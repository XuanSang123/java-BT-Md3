...
//
    ...
    public void displayData() {
        System.out.printf("|ID : %-4s | Name: %-10s| ngày sinh: %10s | Giới tính : %10s | Lương cơ bản  : %10s| người quản lí: %10s | Phòng ban: %10s\n", employeeId, employeeName, birthday, sex, salary, department, manager);
