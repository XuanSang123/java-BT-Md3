package BaiTapXIV.Bai3.run;

import BaiTapXIV.Bai3.entity.Department;
import BaiTapXIV.Bai3.business.DepartmentBusiness;
import BaiTapXIV.Bai3.business.EmployeeBusiness;
import BaiTapXIV.Bai3.business.IDepartmentDesign;
import BaiTapXIV.Bai3.business.IEmployeeDesign;
import BaiTapXIV.Bai3.entity.Department;
import BaiTapXIV.Bai3.entity.Employee;
import BaiTapXIV.Bai3.util.InputMethods;
...
public class DepartmentManagement {
    ...
    private static void showDepartmentList() {
        ...
        if (departments.isEmpty()) {
            ...
            System.out.println("-------- Danh sac phong ban --------");
...
//            Department newDepartment = new Department();
    ...
    private static void showEmployeeList() {
        ...
        if (employees.isEmpty()) System.err.println("Danh sách trống !");
            ...
            System.out.println("-------- Danh sac nhan vien --------");
            for (Employee employee : employees) employee.displayData();
        }
    }

    private static void deleteEmployee() {
        System.out.println("Nhập mã nhan vien cần xóa ");
    ...
    private static void updateEmployee() {
        System.out.println("Nhập mã nhan vien cần chỉnh sửa: ");
    ...
    private static void menuEmployee() {
        while (true) {
            ...
            System.out.println("4. Xóa");
            System.out.println("5. Hiển thị danh sách nhân viên của phòng ban theo mã phòng");
            System.out.println("6. Tìm ra 5 phòng có số lượng nhân viên đông nhất");
            System.out.println("7. Tìm ra người quản lý nhiều nhân viên nhất");
            System.out.println("8. Tìm ra 5 nhân viên có tuổi cao nhất công ty");
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    employeeBusiness.getAvgEmployeesPerDepartment();
                    break;
                case 6:
                    employeeBusiness.findTop5DepartmentsMostCrowded();
                    break;
                case 7:
                    employeeBusiness.findManagerMostEmployees();
                    break;
                case 8:
                    employeeBusiness.findTop5OldestEmployees();
                    break;
                case 9:
                    employeeBusiness.findTop5HighestSalary();
                    break;
                case 10:
